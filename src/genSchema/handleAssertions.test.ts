...
describe('handleAssertions', () => {
    describe('String assertions', () => {
        ...
        it('handles word count assertions', () => {
            ...
            `;
            expect(handleAssertions('z.string()', 'array::len(string::words($value)) > 1', 'string')).toEqualIgnoringWhitespace(multiWordAssert);
        });
        ...
        it('handles conditional word count assertions', () => {
            ...
            `;
            expect(handleAssertions('z.string()', 'IF $value THEN array::len(string::words($value)) > 1 ELSE true END', 'string')).toEqualIgnoringWhitespace(conditionalAssert);
        });
        ...
        describe('Array assertions', () => {
            it('handles array length assertions', () => {
                ...
                expect(handleAssertions('z.array(z.unknown())', 'array::len($value) > 0', 'array')).toEqualIgnoringWhitespace(lengthAssert);
            });
            ...
            it('handles ALLINSIDE assertions', () => {
                ...
                expect(handleAssertions('z.array(z.unknown())', "ALLINSIDE ['a', 'b', 'c']", 'array')).toEqualIgnoringWhitespace(allInsideAssert);
            });

            it('throws error for invalid ALLINSIDE assertions', () => {
                expect(() => handleAssertions('z.array(z.unknown())', 'ALLINSIDE', 'array')).toThrow('Invalid ALLINSIDE assertion');
            });
        });
        ...
        describe('Multiple assertions', () => {
            it('handles multiple assertions combined with AND', () => {
                ...
                expect(handleAssertions('z.string()', 'string::len($value) > 0 AND string::is::email()', 'string')).toBe(multipleAssert);
            });
        });
